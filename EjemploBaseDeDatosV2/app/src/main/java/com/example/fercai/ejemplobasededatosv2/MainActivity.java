package com.example.fercai.ejemplobasededatosv2;
...
/*        //En caso de abrir de forma correcta la base de datos
        if (bd!=null) {
            ...
            //bd.execSQL("DELETE FROM Clientes WHERE nombre='Cliente3' ");
            ...
            nuevoRegistro.put("telefono", "654322910");
...
*/
        ...
        valores.put("telefono", "10555551010XX");
        ...
        String[] args = new String[]{"Fernando", "David", "Angeles"};
